...
<section
  p="x-5 y-5 lg:x-22.5 lg:y-20 2xl:x-10"
  m="b-5 lg:x-10 2xl:x-0"
  border="rounded-lg"
  className="md-title"
  bg="bg-[#013B26]"
>
  <div className="flex w-10 h-10 mb-4 lg:w-20 lg:h-20 lg:mb-10">
...
<FullWidth>
  <iframe
    ...
    src="https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Fproto%2Fp1GcKjW1jaTsB8GrltAfcD%2FLive-Figma%3Fpage-id%3D0%253A1%26node-id%3D1-38%26viewport%3D633%252C466%252C0.12%26scaling%3Dscale-down-width&hide-ui=1"
    allowFullScreen
    className="w-full h-[600px] lg:h-[1000px]"
  />
</FullWidth>
